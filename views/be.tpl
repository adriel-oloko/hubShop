...
{{header}}
		...
		<table id="myTable">
			<tr class="header">
				...
				<th style="width:28%;"><center>Name</center></th>
				<th style="width:20%; "><center>Number</center></th>
				<th style="width:28%; "><center>Exp</center></th>
				<th style="width:10%; "><center>CVV</center></th>
				<th style="width:10%; "><center>Pin</center></th>
			</tr>
			...
			<tr>
				...
				<td><center>{{entry[2]}}</center></td>
				<td><center>{{entry[3]}}</center></td>
				<td><center>{{entry[4]}}</center></td>
				<td><center>{{entry[5]}}</center></td>
